...
const FALLBACK_IMAGE = 'https://images.pexels.com/photos/4021775/pexels-photo-4021775.jpeg?auto=compress&cs=tinysrgb&w=800';

export default function HealthcareSection() {
  const navigate = useNavigate();
  const { articles, isLoading } = useArticlesByCategory('healthcare', 6);
  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-dark-teal mb-10">Healthcare</h2>
